(() => {
  ...
  const DEFAULT_STATE = () => ({
    ...
    settings: { sound: true, music: true, shake: true, reducedMotion: false, lowPerformance: false, difficulty: 'normal' },
    profiles: [{
      id: 'p_' + Date.now(),
      name: 'Jugador',
      avatar: 'explorador',
  ...
  const AudioFX = {
    ...
    stopMusic() {
      clearInterval(this.bossSeqTimer);this.bossSeqTimer=null;this.bossSeqStep=0;
      try {
