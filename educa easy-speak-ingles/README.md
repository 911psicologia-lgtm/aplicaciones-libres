# Easy Speak v0.4.3 — Pronunciation Boost
...
Replace the **whole previous app folder**, not only `index.html`, because v0.4.3 changes `index.html`, `styles.css`, `app.js`, `storage.js`, `service-worker.js`, `manifest.json` and adds `js/pronunciation.js`.
