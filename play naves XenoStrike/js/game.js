...
let META=loadJSON(KEY_META,null)||loadJSON('swarm_rift_meta_v21213',null)||loadJSON('swarm_rift_meta_v21212',null);
...
function pauseGame(){if(G?.screen!=='GAME')return;MusicX.pauseForUI();G.screen='PAUSE';setScreen('PAUSE');AudioX.pause();saveRun();}
