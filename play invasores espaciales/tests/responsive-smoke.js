...
// v0.3.6 structural systems
if(C.VERSION!=='0.3.6') throw new Error('responsive test wrong version');
...
if(!C.enemyEcology||!C.weaponEvolution||!C.bossCore) throw new Error('v0.3.6 ecology/evolution config missing');
console.log('v0.3.6 director/ecology/evolution config: PASS');
