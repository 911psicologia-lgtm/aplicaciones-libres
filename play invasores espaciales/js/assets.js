...
(function(NS){
  ...
  async function loadAll(){ const urls=[...new Set([...Object.values(manifest.ships),...Object.values(manifest.enemies),...manifest.obstacles,...manifest.backgrounds])]; await Promise.all(urls.map(load)); }
