...
const CACHE = 'mpf-r10.16-live-radio';
const CORE = [
  './',
  './index.html',
  './styles.css?v=r10.34-track-visible',
  './sp.css?v=r10.34-track-visible',
  './radio.css?v=r10.34-track-visible',
  './app.js?v=r10.34-track-visible',
  './sp.js?v=r10.34-track-visible',
  './radio.js?v=r10.34-track-visible',
  './manifest.webmanifest?v=r10.34-track-visible',
  './version.json',
  './icons/icon-192.png',
  './icons/icon-512.png',
