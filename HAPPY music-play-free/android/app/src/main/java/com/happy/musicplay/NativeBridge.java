...
public class NativeBridge {
    ...
    /** R10.36 · HAPPY BOOST nativo — activa/desactiva EQ+BassBoost+Loudness+Virtualizer
    ...
    /** R10.36 · Consulta si el BOOST nativo está activo (para sincronizar UI al arrancar). */
    @JavascriptInterface
    ...
    @JavascriptInterface
    public String appVersion() { return "R10.36"; }
