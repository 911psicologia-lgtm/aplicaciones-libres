...
public class NativeBridge {
    ...
    /** R10.23 · HAPPY BOOST nativo — activa/desactiva EQ+BassBoost+Loudness+Virtualizer
    ...
    /** R10.23 · Consulta si el BOOST nativo está activo (para sincronizar UI al arrancar). */
    @JavascriptInterface
    ...
    @JavascriptInterface
    public String appVersion() { return "R10.23"; }
