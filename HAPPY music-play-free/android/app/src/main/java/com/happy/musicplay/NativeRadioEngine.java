...
public final class NativeRadioEngine {
    ...
    public NativeRadioEngine(Context context) {
        ...
        DefaultHttpDataSource.Factory http = new DefaultHttpDataSource.Factory()
                .setUserAgent("MUSIC PLAY HAPPY/R10.16")
    ...
    public void release() { released = true; main.removeCallbacksAndMessages(null); stopRecording(); player.release(); io.shutdownNow(); }
}
